...
rpm-ostree install -C autoconf automake gcc gcc-c++ libpng-devel make ninja-build libvterm poppler poppler-devel poppler-glib-devel pdf-tools pkgconf patch
