...
rpm-ostree install hyprland hyprland-devel xdg-desktop-portal-hyprland hyprland-plugins hyprpaper hypridle hyprlock hyprpolkitagent hyprsysteminfo hyprshot hyprnome hyprdim cmake meson cpio
