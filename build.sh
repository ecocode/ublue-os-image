...
dnf5 -y install niri xdg-desktop-portal-gtk dms noctalia brightnessctl cava cliphist matugen adw-gtk3-theme nwg-look
...
# sway and wayland
dnf5 -y install slurp wdisplays wlr-randr wl-clipboard wofi xdg-desktop-portal-wlr swaybg swayr swayidle swaylock sway-systemd wf-recorder sway-git mangowm umbriel-nightly somewm xdg-desktop-portal-umbriel-nightly
...
# text pdf stuff
dnf5 -y install odt2txt zathura zathura-pdf-poppler zathura-djvu zathura-ps a2ps ghostscript okular
