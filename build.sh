...
# - sway
rpm-ostree install systemd trash-cli gdu duc usbip udisks2 udiskie wpaperd virt-install virt-manager virt-top virt-viewer virtio-win cockpit cockpit-machines cockpit-ostree cockpit-podman w3m samba
# - wayfire
