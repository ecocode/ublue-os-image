...
rpm-ostree install -C lua lua-devel lua-libs luajit lua-lgi cairo-devel pango-devel gdk-pixbuf2-devel wayland-protocols-devel libinput-devel libxkbcommon-devel libdrm-devel xorg-x11-server-Xwayland libxcb-devel xcb-util-devel xcb-util-wm-devel dbus-devel wlroots0.19-devel libasan libubsan
