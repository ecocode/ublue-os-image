...
# - bettercap
rpm-ostree install blueman cryfs digikam distrobox dconf-editor dolphin egl-wayland entr
...
# - sway
rpm-ostree install systemd trash-cli gdu duc usbip udisks2 udiskie wpaperd virt-install virt-manager virt-top virt-viewer virtio-win cockpit cockpit-machines cockpit-ostree cockpit-file-sharing cockpit-podman w3m samba
# - wayfire
