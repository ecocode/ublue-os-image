...
rpm-ostree install -C luajit lua-lgi cairo-devel pango-devel gdk-pixbuf2-devel wayland-protocols-devel libinput-devel libxkbcommon-devel libdrm-devel xorg-x11-server-Xwayland libxcb-devel xcb-util-wm-devel dbus-devel
